...
cooler.balance_cooler(c, store=True, mad_max=7)   # Normalisation 

#file_set_positions= "/home/axel/Bureau/figure_all_chrms/redone/HSC_plasmids_in_Micro-C_WT_log_SC288_genome.txt.sort3"
...
plt.imshow(list_all_contact2, interpolation="none",cmap="afmhot_r", 
           vmin=0.0, vmax=0.0015)
plt.savefig(name_bank+"_files/all_HSC_"+
                "_"+name_bank+"_"+str(BIN/1000)+"kb_scn"+'.pdf')
plt.close("all")    
   
np.savetxt(X=list_all_contact2, fname=name_bank+"_files/all_HSC_"+"_"+name_bank+"_"+str(BIN/1000)+"kb_scn"+'.txt')
...
#plt.ylim(0.0,0.0011)
plt.xlim(0.,40.)
plt.savefig(name_bank+"_files/agglomerated_median_signal_on_HSC_"+
                "_"+name_bank+"_"+str(BIN/1000)+"kb_scn"+'.pdf')
plt.close("all")
